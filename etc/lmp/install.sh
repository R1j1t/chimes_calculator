...
mkdir -p build/lammps_stable_27Oct2024


git clone --depth 1 --branch patch_27Jun2024 https://github.com/lammps/lammps.git build/lammps_stable_27Oct2024
...
cp ../../chimesFF/src/chimesFF.{h,cpp}	build/lammps_stable_27Oct2024/src/MANYBODY/
cp src/pair_chimes.{h,cpp} 		build/lammps_stable_27Oct2024/src/MANYBODY/
cp etc/pair.{h,cpp} 			build/lammps_stable_27Oct2024/src
...
cd build/lammps_stable_27Oct2024/src
...
mkdir exe
mv build/lammps_stable_27Oct2024/src/lmp_mpi_chimes exe
